            ...
            <div key={blog.id} className="rounded-lg overflow-hidden p-3">
              ...
              <div className="text-center py-4">
                ...
                <button
                  ...
                  className="mt-2 bg-gradient-to-r from-[#0980FF] to-[#292929] text-xl px-2 sm:px-6 py-2   rounded-md text-white font-semibold hover:text-[#0980FF] hover:bg-gradient-to-r hover:from-[#eff3f7] hover:to-[#eceff3] hover:border-[#292929] transition duration-300"
                >
                  Read More
                </button>
              </div>
