        ...
        <div className="flex-1 flex flex-col text-white overflow-hidden">
          ...
          <div className="flex justify-center mt-2">
            <motion.button
              ...
              className="bg-gradient-to-r from-[#3195FF] via-[#3195FF] to-[#0980FF] rounded-md text-white text-md font-medium px-3   2xl:py-1 2xl:text-[1.3rem] 2xl:rounded-lg
                     text-center shadow-md hover:text-[#0980FF] hover:bg-gradient-to-r hover:from-[#eff3f7] hover:to-[#eceff3] hover:border-[#292929]"
            >
              Read More
            </motion.button>
          </div>
