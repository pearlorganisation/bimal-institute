...
const LifeAtBimalInstitute = () => {
  const [direction, setDirection] = useState("right"); // Default: Scroll left to right
      ...
      <div className="text-center pb-4 xl:pb-6">
        <div className="flex justify-center items-center text-left">
          <motion.h2
            ...
            className="text-5xl lg:text-6xl 2xl:text-[5.3rem] font-bold bg-gradient-to-r from-[#3195FF] to-[#0940E6] text-transparent bg-clip-text"
