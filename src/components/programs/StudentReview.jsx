  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="text-3xl md:text-5xl 2xl:text-7xl font-semibold mb-8 bg-gradient-to-r from-[#4da3ff] via-[#298df7] to-[#007afb] text-transparent bg-clip-text"
      ...
      <div className="flex flex-col lg:flex-row items-start gap-6">
        {/* Main Video Player */}
        <div className="relative w-full lg:w-[650px] 2xl:w-[810px] 2xl:h-[508px] h-[270px] sm:h-[300px] lg:h-[391px] bg-gray-800 rounded-3xl shadow-lg overflow-hidden">
          <ReactPlayer
        ...
        <div className="flex lg:flex-col gap-4">
          {videos?.map((video, index) => (
            <div
              key={index}
              className={`relative w-[100px] h-[70px] lg:w-[184px] lg:h-[121px] 2xl:h-[161px] 2xl:w-[270px] bg-gray-800 rounded-3xl overflow-hidden cursor-pointer ${
