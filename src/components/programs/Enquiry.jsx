            ...
            >
              ...
              <div className="col-span-2 flex justify-center ">
                <motion.button
                  ...
                  viewport={{ amount: 0.2 }}
                  type="submit"
                  className="bg-[#0980FF] to-[#292929] text-xl px-2 sm:px-6 py-2   rounded-md text-white font-semibold hover:text-[#0980FF] hover:bg-gradient-to-r hover:from-[#eff3f7] hover:to-[#eceff3] hover:border-[#292929] transition duration-300"
                >
                  Submit
                </motion.button>
              </div>
