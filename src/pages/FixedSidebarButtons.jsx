      ...
      <div className="fixed   left-[-2.7rem] sm:left-0 3xl:left-12 top-[40%] z-50 flex flex-col space-y-2">
        ...
        <div className="transform -rotate-90 mb-[65%]">
          <motion.button
            ...
            className="bg-gradient-to-r from-[#3195FF]  to-[#0980FF] rounded text-white text-[0.75rem] sm:text-4   3xl:text-[1rem]   2xl:px-3   3xl:py-[0.4rem] font-semibold px-3 py-1 w-54 
        ...
        <div className="transform -rotate-90">
          <motion.a
            ...
            className="bg-gradient-to-r from-[#3195FF]  to-[#0980FF] rounded text-white text-[0.75rem] sm:text-4     3xl:text-[1rem]  2xl:px-3     3xl:py-[0.9rem] font-semibold px-4 py-2 xl:py-[0.3] 
                     text-center origin-left rounded-r-lg shadow-md"
            style={{
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col sm:flex-row justify-end sm:justify-center space-y-2 sm:space-y-0 sm:space-x-2 mt-4">
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#3195FF] to-[#0980FF] text-white px-4 py-2 rounded-md font-semibold w-full sm:w-auto"
                >
                  Submit
                </button>
              </div>
