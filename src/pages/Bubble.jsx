...
const Bubble = ({ id, text, floating, initialX, initialY }) => {
  ...
  const bubbleSize = isXlScreen ? "w-36 h-36" : "w-24 h-24";
...
const BubbleComponent = () => {
  ...
  return (
    <div className="relative hidden sm:flex sm:flex-col items-center justify-center h-[170vh] xl:h-[105vh] 2xl:h-[115vh] 2.5xl:h-[80vh] 3xl:h-[90vh]   sm:h-[130vh] text-white overflow-hidden pt-12">
      <motion.h2
      ...
      <motion.div
        ...
        className="relative mb-44 mr-12 xl:mr-40 w-full max-w-7xl  lg:max-w-[88%] h-[100vh] 2xl:h-[90vh] 2.5xl:h-[80vh]"
      >
